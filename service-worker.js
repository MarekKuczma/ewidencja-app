...
var WERSJA_CACHE = 'ewidencja-v126';  // 04.09.2026 W-53/W-54: tytul 15 px i jedno slownictwo („Sierpien 2026 zgloszony jako zamkniety”); `stanPo` z API v48 niesie `zgloszoneMiesiace`, wiec karta znika od razu po dopisaniu wpisu; dialog „Zamykam miesiac” i ekran „Wpis dodany” mowia, ze zgloszenie sie cofa. Wymaga API v48.  // 03.09.2026 W-52b: zielona ramka + zielony ptaszek zamiast pastylki; rozwijanie pigulka 'szczegoly' jak przy wpisach.  // 03.09.2026: W-52 — karta „masz zgłoszone" zwinięta do jednej linijki (plakietka + tytuł + „rozwiń"), pełny tekst dopiero po dotknięciu, na końcu „Komunikat zniknie, gdy Marek zarchiwizuje miesiąc".  // 02.09.2026: W-46/W-47 — pulpit mówi, co już zgłoszone („Masz zgłoszone: lipiec i sierpień”), a w ewidencji także KTO zgłosił i czy maszyna ma opiekuna. Wymaga API v47.
